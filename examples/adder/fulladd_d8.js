...
WebAssembly.instantiate(bytes, importObject).then(wa => {
	...
	print(exports.test_I32Add(5, 2, 1923, 4389));
	print(exports.test_I32Sub(4, 1, 3544, 1630));
	print(exports.test_I32Mul(10, 7, 2911, 4710));
	print(exports.test_I32And(7, 9, 3459, 5714));
	print(exports.test_I32Ior(4, 10, 1694, 2489));
	print(exports.test_I32Xor(1, 4, 2201, 1062));
	print(exports.test_I32Eq(5, 8, 2082, 4175));
	print(exports.test_I32Ne(4, 1, 3484, 9201));
	print(exports.test_I32LtU(7, 8, 3987, 7803));
	print(exports.test_I32LeU(2, 3, 155, 4074));
	print(exports.test_I32GtU(1, 10, 5733, 2834));
	print(exports.test_I32GeU(7, 9, 2600, 1602));
	print(exports.test_I32LtS(8, 1, 5380, 8184));
	print(exports.test_I32LeS(10, 10, 4832, 8469));
	print(exports.test_I32GtS(10, 8, 6415, 6316));
	print(exports.test_I32GeS(8, 8, 2631, 5086));
	print(exports.test_F32Add(5, 3, 6954, 1344));
	print(exports.test_F32Sub(4, 6, 7108, 7491));
	print(exports.test_F64Add(7, 9, 2449, 1227));
	print(exports.test_F64Sub(2, 7, 9656, 6078));
	print(exports.test_F32Mul(3, 9, 6489, 9590));
	print(exports.test_F64Mul(10, 7, 6721, 413));
	print(exports.test_F32Div(1, 10, 3327, 6075));
	print(exports.test_F64Div(3, 5, 2086, 2096));
	print(exports.test_I32DivS(1, 4, 1123, 650));
	print(exports.test_I32DivU(6, 3, 9839, 7418));
	print(exports.test_I32RemS(4, 7, 1076, 3579));
	print(exports.test_I32RemU(8, 3, 2953, 7755));
	print(exports.test_I32Shl(8, 2, 7502, 9109));
	print(exports.test_I32ShrU(8, 7, 8126, 5081));
	print(exports.test_I32ShrS(5, 2, 7096, 7697));
	print(exports.test_F32Min(9, 1, 368, 7677));
	print(exports.test_F32Max(7, 2, 3283, 8483));
	print(exports.test_F64Min(4, 9, 7824, 8624));
	print(exports.test_F64Max(1, 2, 6177, 593));
	print(exports.test_F32CopySign(8, 10, 6331, 5656));
	print(exports.test_F64CopySign(5, 3, 5910, 1815));
	print(exports.test_I32Clz(10, 7644));
	print(exports.test_I32Ctz(4, 1267));
	print(exports.test_I32Popcnt(4, 4076));
	print(exports.test_I32Eqz(5, 7039));
	print(exports.test_F32Abs(3, 9920));
	print(exports.test_F32Neg(1, 7958));
	print(exports.test_F32Ceil(8, 7373));
	print(exports.test_F32Floor(4, 8792));
	print(exports.test_F32Trunc(8, 965));
	print(exports.test_F32NearestInt(10, 4263));
	print(exports.test_F64Abs(9, 6213));
	print(exports.test_F64Neg(5, 9482));
	print(exports.test_F64Ceil(1, 3047));
	print(exports.test_F64Floor(9, 9972));
	print(exports.test_F64Trunc(1, 66));
	print(exports.test_F64NearestInt(10, 6681));
